...
protocol BarEditProfileProtocolDelegate {
    func editProfileData()
}

class BarEditProfileView: UIViewController, ScrollViewKeyboardDelegate {
    ...
    var delegate : BarEditProfileProtocolDelegate? = nil
    
    var viewModel = BarEditProfileViewModel()
...
extension BarEditProfileView: UITextFieldDelegate {
...
extension BarEditProfileView: UITextViewDelegate {
...
extension BarEditProfileView: UIImagePickerControllerDelegate,UINavigationControllerDelegate {
...
extension BarEditProfileView: GMSAutocompleteViewControllerDelegate {
