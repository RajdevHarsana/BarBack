...
class BarWorkExpCell: UITableViewCell {
...
class BarSkillCollectionCell: UICollectionViewCell {
    @IBOutlet weak var skillName : UILabel!
}
class BarLanguagesCollectionCell: UICollectionViewCell {
    @IBOutlet weak var languageName : UILabel!
}

class BarShitDetailView: UIViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        self.viewModel.userDetailAPI(userId: userID)
    }
...
extension BarShitDetailView: UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "cell", for: indexPath) as! BarWorkExpCell
...
extension BarShitDetailView: UICollectionViewDelegate,UICollectionViewDataSource{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        if collectionView == skillsCollection {
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "cell", for: indexPath) as! BarSkillCollectionCell
            cell.skillName.text = "   " + "\(self.viewModel.model[0].data?.userSkill?[indexPath.row].skill ?? "")" + "    "
            return cell
        }else{
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "cell", for: indexPath) as! BarLanguagesCollectionCell
...
extension BarShitDetailView: UICollectionViewDelegateFlowLayout{
