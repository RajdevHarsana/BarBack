...
//    let API_URL = "http://admin.3alamalhaflat.com"//Live
    let API_URL = "http://13.127.222.86"//Live
    
    let IMG_URL = "http://partyworld.arkasoftwares.in/public/uploads/users/profile/"//web content
